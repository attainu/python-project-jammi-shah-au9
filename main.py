...
def load_images():
    ...
    for piece in pieces:
        images[piece] = p.transform.scale(p.image.load("E:\Project2\images/"+piece+".png"), (sqSize, sqSize))
...
def draw_board(screen):
    colors = [p.Color("orange"), p.Color("green")]
    for r in range(dimension):
        for c in range(dimension):
            color = colors[((r + c) % 2)]  # 2nd row 5th column = 7 // 2 = 3 green
